...
public class CreateOrgCopyBillingEnabledOrNotBeforePOMTest {
...
public static void main(String[] args) throws IOException {
		...
		boolean copyBillingRadioEnabled = copyBillingRadio.isSelected();
		jlib.printStatement("copyShippingRadioSelectedOnFirstClick :-  "+copyBillingRadioEnabled);
		
		copyBillingRadio.click();
		
		boolean copyBillingRadioDisabled = copyBillingRadio.isSelected();
