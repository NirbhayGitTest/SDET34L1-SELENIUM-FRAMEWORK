...
public class CreateOrgWithShippingAddressBeforeTestNGTest {
	...
	public static void main(String[] args) throws IOException {
		...
		jlib.assertionThroughIfCondition(savedBillingaddress, shippingAddress, "Org saved with shipping address");
