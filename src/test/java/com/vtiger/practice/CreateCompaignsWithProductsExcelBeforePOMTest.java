...
public class CreateCompaignsWithProductsExcelBeforePOMTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String compaignname = WorkbookLibrary.getDataFromExcel("Campaign", 2, 1) + randomNumber;
		
	    jLib.printStatement(compaignname);
	   ...
	   jLib.printStatement(productname);
	 		...
	 		seleniumLibrary.mouseOverOnTheElement(more);
...
////////////	 		
	 		...
	 		//{
	 		//	jLib.printStatement("Compaign created successfully");
	 		//	jLib.printStatement("Test case pass");
	 		//}
	 		jLib.assertionThroughIfCondition(actualname.getText(), compaignname, "Compaign");
