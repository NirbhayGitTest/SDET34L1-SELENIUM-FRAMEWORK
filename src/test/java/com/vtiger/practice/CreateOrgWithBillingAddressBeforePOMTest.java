...
public class CreateOrgWithBillingAddressBeforePOMTest {
...
public static void main(String[] args) throws IOException {
		...
		String valueInShippingAddress = driver.findElement(By.xpath("//textarea[@name='ship_street']")).getAttribute("value");
